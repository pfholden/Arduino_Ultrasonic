...
CMD_AVR_ASM = avr-as ${FLAGS_ASM} ${INCLUDE}
CMD_AVR_AR = avr-ar rcs

CORE_CPP_SOURCES = $(wildcard ${ARDUINO_CORE_DIR}/*.cpp)
CORE_C_SOURCES = $(wildcard ${ARDUINO_CORE_DIR}/*.c)
CORE_ASM_SOURCES = $(wildcard ${ARDUINO_CORE_DIR}/*.S)
COBJECTS=$(CORE_CPP_SOURCES:.cpp=.cpp.o) $(CORE_C_SOURCES:.c=.c.o) $(CORE_ASM_SOURCES:.S=.S.o)
...
${LIB_CORE_DIR}/%.S.o: ${ARDUINO_CORE_DIR}/%.S
	mkdir -p $(dir $@)
	${CMD_AVR_ASM} $< -o $@
